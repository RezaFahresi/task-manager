<x-app-layout :title="'Tambah Kategori - Task Manager'">
    <div class="container-fluid px-3 px-md-4 py-4 max-w-2xl mx-auto">
        ...
        <div class="d-flex flex-column flex-md-row md:align-items-center justify-content-between gap-3 pb-4 mb-4 border-bottom">
            <div>
                ...
                <h1 class="h3 fw-bold text-dark mb-1 tracking-tight">Tambah Kategori</h1>
                <p class="text-secondary small mb-0">Buat kategori baru untuk mengelompokkan task Anda.</p>
            </div>
        </div>
